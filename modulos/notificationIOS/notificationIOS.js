...
import {
  nanoid
} from 'https://cdn.skypack.dev/nanoid';
import {
  BsCheckLg,
  BsXLg,
  BsInfoLg,
...
import {
  MdClose,
  MdAdd
} from 'https://cdn.skypack.dev/react-icons/md';
import {
  TransitionGroup,
  CSSTransition
...
const Notifications = ({
  ...
  return (React.createElement(TransitionGroup, {
    ...
    onMouseEnter: pause,
    onMouseLeave: resume
  }, [...notifications].reverse().map((notification, index) => (React.createElement(CSSTransition, {
      key: notification.id,
...
export const App = () => {
  ...
  return (
    React.createElement("div", {
        className: 'notificationIOS-container'
      },
      React.createElement(Notifications, Object.assign({}, props, {
        animationDuration: ANIMATION_DURATION
      })),
      React.createElement("button", {
          id: "notificationIOS",
          className: 'notificationIOS-button',
          onClick: () => {
            ...
            add({
              title: notificationIOS.title,
              content: notificationIOS.content,
              timeout: notificationIOS.timeout || TIMEOUT,
              type: notificationIOS.type
            });
          }
        },
...
ReactDOM.render(React.createElement(App, null), document.querySelector("#notificationIOS-section"));