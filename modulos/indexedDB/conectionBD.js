...
const agregar = (nombreTabla, data) => {
    //Definir el tipo de transaccion y sobre que colección se realizará
    const trasaccion = db.transaction([nombreTabla],'readwrite')
    //Obtener la colección de la transacción
    const coleccionObjetos = trasaccion.objectStore(nombreTabla)
...
const obtener = (nombreTabla, clave) =>{
    const trasaccion = db.transaction([nombreTabla],'readonly')
    const coleccionObjetos = trasaccion.objectStore(nombreTabla)
...
const actualizar = (nombreTabla, data) =>{    
    const trasaccion = db.transaction([nombreTabla],'readwrite')
    const coleccionObjetos = trasaccion.objectStore(nombreTabla)
...
const eliminar = (nombreTabla, clave) =>{      
    const trasaccion = db.transaction([nombreTabla],'readwrite')
    const coleccionObjetos = trasaccion.objectStore(nombreTabla)
